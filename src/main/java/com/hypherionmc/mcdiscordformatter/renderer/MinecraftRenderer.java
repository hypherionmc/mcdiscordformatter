 ...
 * {@link Component}s for standard {@link TextStyle}s.
 */
public interface MinecraftRenderer extends MinecraftNodeRenderer {
    ...
    default Component render(Component component, Node<Object> node, MinecraftSerializerOptions<Component> serializerOptions,
        ...
        if (node instanceof TextNode) {
            component = Component.text(((TextNode<Object>) node).getContent());
     ...
     *
     * @param MutableComponent the {@link Component} to render the spoiler to
     ...
     */
    @Nullable
    Component appendSpoiler(@NotNull Component MutableComponent, @NotNull Component content);

    /**
     * Adds the required formatting for quotes to the provided {@link Component}.
     *
     * @param MutableComponent the {@link Component} to render to
     ...
     */
    @Nullable
    Component appendQuote(@NotNull Component MutableComponent, @NotNull Component content);
     ...
     */
    @Nullable
    Component appendEmoteMention(@NotNull Component MutableComponent, @NotNull String name, @NotNull String id);
     ...
     */
    @Nullable
    Component appendChannelMention(@NotNull Component MutableComponent, @NotNull String id);
     ...
     */
    @Nullable
    Component appendUserMention(@NotNull Component MutableComponent, @NotNull String id);
     ...
     */
    @Nullable
    Component appendRoleMention(@NotNull Component MutableComponent, @NotNull String id);
}
