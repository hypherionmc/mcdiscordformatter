...
import com.hypherionmc.mcdiscordformatter.renderer.MinecraftRenderer;
...
public class DefaultMinecraftRenderer implements MinecraftRenderer {
    ...
    @Override
    public Component appendQuote(Component component, @NotNull Component content) {
    ...
    @Override
    public Component appendEmoteMention(Component component, @NotNull String name, String id) {
        return component.append(Component.text(":" + name + ":"));
    }

    @Override
    public Component appendChannelMention(Component component, @NotNull String id) {
        return component.append(Component.text("<#" + id + ">"));
    }

    @Override
    public Component appendUserMention(Component component, @NotNull String id) {
        return component.append(Component.text("<@" + id + ">"));
    }

    @Override
    public Component appendRoleMention(Component component, @NotNull String id) {
        return component.append(Component.text("<@&" + id + ">"));
    }
}
