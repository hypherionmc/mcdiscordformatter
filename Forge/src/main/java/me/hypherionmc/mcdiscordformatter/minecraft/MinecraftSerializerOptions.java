...
public class MinecraftSerializerOptions<O> {
    ...
    public MinecraftSerializerOptions(@Nonnull Parser<Object, Node<Object>, Object> parser, List<Rule<Object, Node<Object>, Object>> rules, @Nonnull List<NodeRenderer<O>> renderers, boolean debuggingEnabled) {
        this.parser = parser;
        this.rules = rules;
     ...
     */
    public static MinecraftSerializerOptions<IFormattableTextComponent> defaults() {
    ...
    public @Nonnull Parser<Object, Node<Object>, Object> getParser() {
        return this.parser;
    }
    ...
    public MinecraftSerializerOptions<O> withParser(@Nonnull Parser<Object, Node<Object>, Object> parser) {
