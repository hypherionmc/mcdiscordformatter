...
public class MinecraftSerializer {
    ...
    public static final MinecraftSerializer INSTANCE = new MinecraftSerializer() {
        ...
        @Override
        public void setDefaultOptions(MinecraftSerializerOptions<IFormattableTextComponent> defaultOptions) {
     ...
     */
    private MinecraftSerializerOptions<IFormattableTextComponent> defaultOptions;
     ...
     */
    public MinecraftSerializer(@Nonnull MinecraftSerializerOptions<IFormattableTextComponent> defaultOptions,
     ...
     */
    public IFormattableTextComponent serialize(@Nonnull final String discordMessage) {
        MinecraftSerializerOptions<IFormattableTextComponent> options = getDefaultOptions();
     ...
     * @see MinecraftSerializerOptions#MinecraftSerializerOptions(dev.vankka.simpleast.core.parser.Parser, List, List, boolean)
     */
    public IFormattableTextComponent serialize(@Nonnull final String discordMessage, @Nonnull final MinecraftSerializerOptions<IFormattableTextComponent> serializerOptions) {
        ...
        for (Node<Object> node : nodes) {
            components.add(addChild(node, new StringTextComponent(""), serializerOptions));
        }
    ...
    private IFormattableTextComponent addChild(final Node<Object> node, final IFormattableTextComponent styleNode,
                               final MinecraftSerializerOptions<IFormattableTextComponent> serializerOptions) {
        IFormattableTextComponent component = new StringTextComponent("").setStyle(styleNode.getStyle());
        Function<Node<Object>, IFormattableTextComponent> renderWithChildren = otherNode -> addChild(otherNode, component, serializerOptions);

        IFormattableTextComponent output = null;
        NodeRenderer<IFormattableTextComponent> render = null;
        for (NodeRenderer<IFormattableTextComponent> renderer : serializerOptions.getRenderers()) {
        ...
        IFormattableTextComponent newOutput = render.renderAfterChildren(output, node, serializerOptions, renderWithChildren);
        if (newOutput != null) {
            output = newOutput;
        }
    ...
    public MinecraftSerializerOptions<IFormattableTextComponent> getDefaultOptions() {
