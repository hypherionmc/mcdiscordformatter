...
public class DefaultDiscordEscapingRenderer implements NodeRenderer<String> {
    ...
    /**
     * The instance of {@link DefaultDiscordEscapingRenderer}.
     */
    public static final DefaultDiscordEscapingRenderer INSTANCE = new DefaultDiscordEscapingRenderer();

    /**
     * Creates a new instance of the {@link DefaultDiscordEscapingRenderer} unless you're extending the class you shouldn't use this.
     * @see #INSTANCE
     */
