...
public interface MinecraftRenderer extends MinecraftNodeRenderer {
    ...
    @Override
    default IFormattableTextComponent render(IFormattableTextComponent MutableComponent, Node<Object> node, MinecraftSerializerOptions<IFormattableTextComponent> serializerOptions,
                                  Function<Node<Object>, IFormattableTextComponent> renderWithChildren) {
        if (node instanceof TextNode) {
            MutableComponent = new StringTextComponent(((TextNode<Object>) node).getContent());
     ...
     */
    @Nullable
    IFormattableTextComponent strikethrough(@Nonnull IFormattableTextComponent part);
     ...
     */
    @Nullable
    IFormattableTextComponent underline(@Nonnull IFormattableTextComponent part);
     ...
     */
    @Nullable
    IFormattableTextComponent italics(@Nonnull IFormattableTextComponent part);
     ...
     */
    @Nullable
    IFormattableTextComponent bold(@Nonnull IFormattableTextComponent part);
     ...
     */
    @Nullable
    IFormattableTextComponent codeString(@Nonnull IFormattableTextComponent part);
     ...
     */
    @Nullable
    IFormattableTextComponent codeBlock(@Nonnull IFormattableTextComponent part);
     ...
     */
    @Nullable
    IFormattableTextComponent appendSpoiler(@Nonnull IFormattableTextComponent MutableComponent, @Nonnull IFormattableTextComponent content);
     ...
     */
    @Nullable
    IFormattableTextComponent appendQuote(@Nonnull IFormattableTextComponent MutableComponent, @Nonnull IFormattableTextComponent content);
     ...
     */
    @Nullable
    IFormattableTextComponent appendEmoteMention(@Nonnull IFormattableTextComponent MutableComponent, @Nonnull String name, @Nonnull String id);
     ...
     */
    @Nullable
    IFormattableTextComponent appendChannelMention(@Nonnull IFormattableTextComponent MutableComponent, @Nonnull String id);
     ...
     */
    @Nullable
    IFormattableTextComponent appendUserMention(@Nonnull IFormattableTextComponent MutableComponent, @Nonnull String id);
     ...
     */
    @Nullable
    IFormattableTextComponent appendRoleMention(@Nonnull IFormattableTextComponent MutableComponent, @Nonnull String id);
}
